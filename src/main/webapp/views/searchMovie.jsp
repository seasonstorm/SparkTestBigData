...
<div style="background-image: url('https://img.zcool.cn/community/01b31c596b2710a8012193a3269ebb.jpg@1280w_1l_2o_100sh.jpg');height:100vh;background-repeat: no-repeat;background-size: 100% 99.5vh;">
    ...
    <form action="searchResult" method="get" style="display: flex;flex-direction: row;">
        <div class="layui-input-block">
            <input type="text" name="keyword" lay-verify="title" style="width: 40em;margin-left: 20em;"
                   autocomplete="off" placeholder="请输入关键字" class="layui-input">
        </div>
        <div class="layui-input-block">
            <label class="layui-form-label">电影平均分范围</label>
            <input type="text" name="start_score" lay-verify="title" autocomplete="off" placeholder="请输入起始值"
                   class="layui-input">
            <input type="text" name="start_score" lay-verify="title" autocomplete="off" placeholder="请输入结束值"
                   class="layui-input">
        </div>
        <button type="submit" class="layui-btn layui-btn-normal" style="margin-left: 1em;" onclick="search()">搜索
        </button>
    </form>
</div>
</body>
